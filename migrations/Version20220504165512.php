 ...
 */
final class Version20220504165512 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE livre ADD auteur_id INT DEFAULT NULL, CHANGE annee annã©e DATE DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE livre DROP auteur_id, CHANGE annã©e annee DATE DEFAULT NULL');
    }
}
